...
{
    public class SlabProductMarkDto
    {
        ...
        public int BITBENDINDICATOR { get; set; }

        public int BITCREEPDEDUCTATMO1 { get; set; }
        public int BITCREEPDEDUCTATCO1 { get; set; }
       ...
       public string VCHPRODUCTVALIDATORDESCRIPTION { get; set; }
       ...
       public int INTCWBENDPOSITION { get; set; }
        ...
        public int BENDINGCHECK { get; set; }
