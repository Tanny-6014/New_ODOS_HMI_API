    ...
    public List<ShapeCode> ShapeCodeForBeam_Get()
        ...
        public List<ShapeCode> FilterShapeCodeForBeam_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dataAdapter.SelectCommand = new SqlCommand(SystemConstant.FilterShapeCodeForBeam_Get, sqlConnection);
                    ...
                    dataAdapter.Fill(dsShapeCodeForBeam);
        ...
        public List<ShapeCode> ColumnShapeCode_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    var dataAdapter = new SqlDataAdapter();
                    dataAdapter.SelectCommand = new SqlCommand(SystemConstant.ColumnShapeCode_Get, sqlConnection);
                    dataAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;
                    dataAdapter.SelectCommand.Parameters.AddRange(dynamicParameters.ParameterNames.Select(name => new SqlParameter(name, dynamicParameters.Get<object>(name))).ToArray());
                    ...
                    // Fill the DataSet with the results of the stored procedure
                    dataAdapter.Fill(dsColumnShapeCode);
        ...
        public List<ShapeCode> SlabShapeCodeFilter_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    var dataAdapter = new SqlDataAdapter();
                    dataAdapter.SelectCommand = new SqlCommand(SystemConstant.SlabShapeCodeFilter_Get, sqlConnection);
                    dataAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;
                    dataAdapter.SelectCommand.Parameters.AddRange(dynamicParameters.ParameterNames.Select(name => new SqlParameter(name, dynamicParameters.Get<object>(name))).ToArray());
                    ...
                    // Fill the DataSet with the results of the stored procedure
                    dataAdapter.Fill(dsSlabShapeCode);
        ...
        public List<ShapeCode> CarpetShapeCode_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    {
                        DataTable dt = ConvertToDataTable.ToDataTable(slabShapeCodeDtos);
                        dsCarpetShapeCode.Tables.Add(dt);
        ...
        public List<ShapeCode> CarpetShapeCodeFilter_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand(SystemConstant.SlabShapeCodeFilter_Get, sqlConnection);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@VCHENTEREDTEXT", enteredText));

                    SqlDataAdapter adapter = new SqlDataAdapter(cmd);
                    adapter.Fill(dsCarpetShapeCode);
        ...
        public List<ShapeCode> ShapeCodeNoFilter_Get()
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCapShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstant.ShapeCodeNoFilter_Get, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> FilterShapeCodeForCab_Get(string enteredText)
        {
            ...
            try
            {
                ...
                {  
                    sqlConnection.Open();
                    SqlCommand cmd = new SqlCommand(SystemConstant.FILTERSHAPECODEFORCAB_GET, sqlConnection);
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@CHRSHAPETEXT", enteredText));

                    SqlDataAdapter adapter = new SqlDataAdapter(cmd);
                    adapter.Fill(dsShapeCodeForCab);
        ...
        //public List<ShapeCode> PopulateShapeCodeForCab_Get()
        //{
