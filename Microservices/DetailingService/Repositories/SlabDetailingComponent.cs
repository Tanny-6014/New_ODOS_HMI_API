...
namespace DetailingService.Repositories
{
    ...
    //private string connectionString = "Server=NSPRDDB19\\MSSQL2022;Database=ODOS;TrustServerCertificate=True;MultipleActiveResultSets=true;User=ndswebapps;Password=DBAdmin4*NDS;Connection Timeout=36000000";
        ...
        public SlabDetailingComponent(DetailingApplicationContext dbContext, IConfiguration configuration)
        {
        ...
        public Dictionary<string, string> GetProductMarkingFormulae(int shapeId)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    Formula = sqlConnection.Query<SlabValidationFormulaDto>(SystemConstant.GetProductMarkingFormulaForShape, dynamicParameters, commandType: CommandType.StoredProcedure);
                    if (Formula.Count() > 0)
                    {
        ...
        public double GetMWLength(int shapeId, Dictionary<string, string> dict_ip)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    Formula = sqlConnection.Query<BeamFormulaDto>(SystemConstant.GetMWLengthFormula, dynamicParameters, commandType: CommandType.StoredProcedure);
                    ...
                    //dsProductMark = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "GetProductMarkingFormulaForShape");
                    beamproductMarkingFormulaForShapeDto = sqlConnection.Query<BeamProductMarkingFormulaForShapeDto>(SystemConstant.GetProductMarkingFormulaForShape, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public Dictionary<string, string> GetValidationConstraints(int shapeId)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    listValidationsDto = sqlConnection.Query<ValidationsDto>(SystemConstant.GetInputOutputValidationForShape, dynamicParameters, commandType: CommandType.StoredProcedure);
            ...
            try
            {
                ...
                else if (isEqualToPresent == true && andsign == false)
                {
                    ...
                    foreach (var splitedFormula in splittedEqualToList)
                    {
                        ...
                        ConditionResult = objParse.EvaluateFormula(formula1, false);
                        ConditionResult = Math.Round(ConditionResult);
        ...
        public List<DataRow> GetShapeParams(int ShapeId)
        {
            ...
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                dsParameters = (DataSet)sqlConnection.Query<DataSet>(SystemConstant.GetShapeParametersForShapeId, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public Dictionary<string, string> GetStructuteMarkingFormulae(string strelement)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    StructureMarkingFormulaeElementDto = sqlConnection.Query<ColumnStructureMarkingFormulaeElementDto>(SystemConstant.GetStructureMarkingFormulaeElement, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public Dictionary<string, string> GetDrainProductMarkingFormulae(string strElement, string shapecode, string layername)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsDrainProductMark = (DataSet)sqlConnection.Query<DataSet>(SystemConstant.GetDrainProductMarkingFormuale, dynamicParameters, commandType: CommandType.StoredProcedure);
