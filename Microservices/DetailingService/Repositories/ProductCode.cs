...
namespace DetailingService.Repositories
{
    public class ProductCode
    {
        ...
        public Int32 SITLEG { get; set; }
        public Int32 sitHook { get; set; }
        ...
        public ProductCode(DetailingApplicationContext dbContext, IConfiguration configuration)
        {
        ...
        public List<ProductCode> FilterCapProductForBeam_Get(string enteredText)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    beamCapProductDto = sqlConnection.Query<BeamCapProductDto>(SystemConstant.FilterCapProductForBeam_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        //public List<ProductCode> ColumnLeg_Get(int parameter, int productid)
        //{

        //    List<ProductCode> listCapProductCode = new List<ProductCode> { };
        //    DataSet dsCapProductCode = new DataSet();
        //    IEnumerable<ColumnLegDto> GetValues;
        //    try
        //    {
        ...
        //            dynamicParameters.Add("@tntparameterset", parameter);
        //            dynamicParameters.Add("@intproductid", productid);


        //            //dsCapProductCode = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "usp_CapProductCodeNoFilter_Cache_Get");
        //            //dsCapProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstant.GetColumnLeg, dynamicParameters, commandType: CommandType.StoredProcedure);
        //            GetValues = sqlConnection.Query<ColumnLegDto>(SystemConstant.GetColumnLeg, dynamicParameters, commandType: CommandType.StoredProcedure);

        //            if (GetValues.Count() > 0)
        //            {
        //                DataTable dt = ConvertToDataTable.ToDataTable(GetValues);
        //                dsCapProductCode.Tables.Add(dt);
        //            }
        ...
        //                    ProductCode productCode = new ProductCode
        //                    {
        //                        SITLEG = Convert.ToInt32(drvBeam["SITLEG"]),
        //                        sitHook = Convert.ToInt32(drvBeam["sitHook"])
        //                    };
        ...
        #region " ACS Productcode"
        public List<ProductCode> ACSProductCodeFilter(string enteredText)
        {
...

            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    // dsSlabProductCode = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "usp_SlabProductCodeFilter_Get");
                    productCodes = sqlConnection.Query<SlabProductCodeDto>(SystemConstant.usp_ACSProduct_Get,  commandType: CommandType.StoredProcedure);
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    //dsCarpetProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstant.CarpetProductCode_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
                        ...
                        dataAdapter.SelectCommand = new SqlCommand(SystemConstant.CarpetProductCode_Get, sqlConnection);
        ...
        public List<ProductCode> CarpetProductCode_New()
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    var dataAdapter = new SqlDataAdapter();
                    dataAdapter.SelectCommand = new SqlCommand(SystemConstant.CarpetProductCode_Get_New, sqlConnection);
                    dataAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;
                    dataAdapter.Fill(dsCarpetProductCode);
        ...
        public List<ProductCode> CarpetProductCodeFilter(string enteredText)
        {
            ...
            List<ProductCode> listCarpetProductCode = new List<ProductCode> { };
            DataSet dsCarpetProductCode = new DataSet();
            IEnumerable<CarpetProductCodeDto> productCodes;
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    productCodes = sqlConnection.Query<CarpetProductCodeDto>(SystemConstant.CarpetProductCodeFilter_Get, dynamicParameters, commandType: CommandType.StoredProcedure);


                    if (productCodes.Count() > 0)
                    {
                        DataTable dt = ConvertToDataTable.ToDataTable(productCodes);
                        dsCarpetProductCode.Tables.Add(dt);
                    }
        ...
        public List<ProductCode> CapProductCodeNoFilter_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    //dsCapProductCode = dbManager.ExecuteDataSet(CommandType.StoredProcedure, "usp_CapProductCodeNoFilter_Cache_Get");
                    dsCapProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstant.CapProductCodeNoFilter_Cache_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        #endregion
        public List<ColumnLegDto> ColumnLeg_Get(int parameter, int productid)
        {
