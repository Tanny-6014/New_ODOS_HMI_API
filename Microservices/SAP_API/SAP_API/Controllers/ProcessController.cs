...
namespace SAP_API.Controllers
{
    ...
    public class ProcessController : Controller
    {
        ...
        //    if (lUserType == null || lUserType == "" || lUserType == "CA" || lUserType == "CA")
        //    {
        ...
        public ActionResult Index(string rCustomerCode, string rProjectCode)
        {
            ...
            lRst.Close();
            CloseNDSConnection(ref lNDSCon);
        ...
        //[Route("/getSAPOrderType/{pProjectCode}/{pContractNo}/{pPaymentType}/{pMTOMTS}")]
        //public string getSAPOrderType(string pProjectCode, string pContractNo, string pPaymentType, string pMTOMTS)
        //{
        //    // Get SAP Order type from parameters
        //    // Project Code - Ship to party or Spot order project code
        //    // pContractNo - Contract or Blank for Spot order 
        //    // Payment Type - CREDIT, CASH, FOC
        //    // MTO / MTS - MTO, MTS

        //    string lSAPOrderType = "";
        //    string lDomExp = "DOM";     // DOM / EXP
        //    string lCategory = "C";     // C / N

        //    string lSQL = "";
        //    SqlConnection lNDSCn;
        //    SqlCommand lCmd;
        //    SqlDataReader lRst;


        //    lNDSCn = new SqlConnection();
        //    OpenNDSConnection(ref lNDSCn);


        //    if (pProjectCode == null) pProjectCode = "";
        //    if (pContractNo == null) pContractNo = "";
        //    if (pPaymentType == null) pPaymentType = "";
        //    if (pMTOMTS == null) pMTOMTS = "";

        //    pProjectCode = pProjectCode.Trim();
        //    pContractNo = pContractNo.Trim();
        //    pPaymentType = pPaymentType.Trim();
        //    pMTOMTS = pMTOMTS.Trim();

        //    if (pContractNo == "")
        //    {
        //        lCategory = "N";

        //        lSQL = "SELECT dom_exp FROM dbo.OESSpotProjects WHERE spot_project_code = '" + pProjectCode + "' ";
        ...
        //        {
        //            lRst.Read();
        //            lDomExp = (string)lRst.GetValue(0);
        //        }
        //        lRst.Close();
        //    }
        //    else
        ...
        //        if (pContractNo.Substring(0, 3) == "112" || pContractNo.Substring(1, 3) == "112")
        //        {
        //            lDomExp = "EXP";
        //        }
        //        else
        ...
        //    lSQL = "SELECT order_type " +
        //    "FROM dbo.OESOrderType " +
        //    "WHERE dom_exp = '" + lDomExp + "' " +
        //    "AND order_category = '" + lCategory + "' " +
        //    "AND payment_type = '" + pPaymentType + "' " +
        //    "AND mto_mts = '" + pMTOMTS + "' ";
        ...
        //    {
        //        lRst.Read();
        //        lSAPOrderType = (string)lRst.GetValue(0);
        //    }
        //    lRst.Close();


        //    CloseNDSConnection(ref lNDSCn);
        //    lNDSCn = null;
        //    lCmd = null;
        //    lRst = null;

        //    return lSAPOrderType;
        //}

        //[Route("/getSAPSalesOrg/{pProjectCode}/{pContractNo}")]
        //public string getSAPSalesOrg(string pProjectCode, string pContractNo)
        //{

        //    string lSAPSalesOrg = "6401";
        ...
        //    if (pContractNo.Trim() == "")
        //    {
        //        string lCountryCode = "SG";
        //        lNDSCn = new SqlConnection();
        //        OpenNDSConnection(ref lNDSCn);

        //        lSQL = "SELECT MAX(country_code) FROM dbo.OESProject WHERE ProjectCode = '" + pProjectCode.Trim() + "' ";
        ...
        //        {
        //            lRst.Read();
        //            lCountryCode = (string)lRst.GetValue(0);
        //        }
        //        lRst.Close();
        ...
        public Boolean SetConnectString()
        {
            if (strServer == "PRD")
            {
                strNDS_Connection = "Data Source=NSPRDDB19\\MSSQL2022\\MSSQL2022;Initial Catalog=ODOS;User ID=ndswebapps; Password=DBAdmin4*NDS; MultipleActiveResultSets=false; Connection Timeout=120";
                ...
                //strNDS_Connection = "Provider=sqloledb; Data Source=NSPRDDB19\\MSSQL2022,1433;Initial Catalog=NDSDB;User ID=ots_support; Password=ots1nprod";
                //strNDS_Connection = "Data Source=NSPRDDB19\\MSSQL2022,1433;Initial Catalog=NDSDB;User ID=ots_support; Password=ots1nprod; MultipleActiveResultSets=false; Connection Timeout=120";
            ...
            else
            {
                ...
                //strNDS_Connection = "Provider=sqloledb; Data Source=NSPRDDB19\\MSSQL202;Initial Catalog=NDSPRD;User ID=ots_support; Password=ots1nqa";
        ...
        public async Task<ActionResult> CancelProcess(string CustomerCode,
            string ProjectCode,
            string ContractNo,
            int JobID,
            ...
            string ActionType)
        {
            ...
            sUserID = "jagdishH_ttl@natsteel.com.sg";//User.Identity.GetUserName().ToUpper();
        ...
        [HttpGet]
        [Route("/RemoveGroupMarking/{pCustCode}/{pProject}/{pContract}/{pPostID}/{pStrucEle}/{pProdType}/{pGroupMarking}/{pRev}")]
...
string pStrucEle, string pProdType, string pGroupMarking, int pRev)
        {
            ...
            try
            {
                ...
                //Get Project ID
                lSQL = "SELECT intProjectId FROM dbo.SAPProjectMaster P WHERE vchProjectCode = '" + pProject + "' ";
                lCmd = new SqlCommand(lSQL, cnNDS);
                lCmd.Transaction = osqlTransNDS;
                lCmd.CommandTimeout = 1200;
