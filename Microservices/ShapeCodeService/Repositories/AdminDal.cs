...
public class AdminDal : IAdminDal
{
    ...
    //    }
    //}
    public List<StatusDetailsDto> GetStatusDetails()
    {
        try
        {
            IEnumerable<StatusDetailsDto> statusDetails = null;
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
                statusDetails = sqlConnection.Query<StatusDetailsDto>(SystemConstants.WBSStatus_Get, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return statusDetails.AsList();
    ...
    public List<getShapeDetailsDto> GetShape()
    {
        try
        {
            IEnumerable<getShapeDetailsDto> shapeDetails = null;
            using(SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
                shapeDetails = sqlConnection.Query<getShapeDetailsDto>(SystemConstants.Shape_Get, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return shapeDetails.AsList();
    ...
    public List<GetShapeParamDetailsDto>GetShapeParamDetails(int ShapeId)
    {
        try
        {
    ...
    public int InsUpdShapeParamDetails(int UserId,GetShapeParamDetailsDto obj)
    {
        try
        {
            int intReturnValue = 0;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                sqlConnection.Open();
                dynamicParameters.Add("@intShapeId", obj.intShapeID);
                dynamicParameters.Add("@intShapeDetailId",Convert.ToInt32(obj.intShapeDetailId));
                dynamicParameters.Add("@chrParamName", obj.chrParamName);
                dynamicParameters.Add("@intParamSeq", Convert.ToInt32(obj.intParamSeq));
                dynamicParameters.Add("@vchMWShape", obj.vchMWShape);
                dynamicParameters.Add("@vchCWShape", obj.vchCWShape);
                dynamicParameters.Add("@chrWireType", obj.chrWireType);
                dynamicParameters.Add("@chrAngleType", obj.chrAngleType);
                dynamicParameters.Add("@intAngleDir", obj.intAngleDir);
                dynamicParameters.Add("@intBendSeq1", obj.intBendSeq1);
                dynamicParameters.Add("@intBendSeq2", obj.intBendSeq2);
                dynamicParameters.Add("@chrCriticalInd", obj.chrCriticalInd);
                dynamicParameters.Add("@intMinLen", obj.intMinLen);
                dynamicParameters.Add("@intMaxLen", obj.intMaxLen);
                dynamicParameters.Add("@intConstValue", obj.intConstValue);
    ...
    public int DeleteShapeParamDetails(int ShapeDetailsId)
    {
        try
        {
            int intReturnValue = 0;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                sqlConnection.Open();
                var dynamicParameters = new DynamicParameters();
                dynamicParameters.Add("@intShapeDetailId ",ShapeDetailsId); 
                dynamicParameters.Add("@Output", 0);
    ...
    public List<ChkShapeExistDto> GetShapeCodeDetails(int ShapeId)
    {
        try
        {
            IEnumerable<ChkShapeExistDto> shapeCodeDetailsDtos;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
                var dynamicParameters = new DynamicParameters();
                dynamicParameters.Add("@intShapeCode",ShapeId);
                shapeCodeDetailsDtos = sqlConnection.Query<ChkShapeExistDto>(SystemConstants.ShapeCodeDetails_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();

                return shapeCodeDetailsDtos.ToList();
            }
    ...
    public int InsUpdShapeHeaderDetails(int UserID,InsUpdShapeHeaderDto obj)
    {
        try
        {
            int intReturnValue = 0;
            ...
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                sqlConnection.Open();
                var dynamicParameters = new DynamicParameters();
                //dynamicParameters.Add("@intShapeId",Convert.ToInt32(obj.ShapeId));
                ...
                dynamicParameters.Add("@intUID", UserID);
                dynamicParameters.Add("@Output", 0);
                intReturnValue=sqlConnection.QueryFirstOrDefault<int>(SystemConstants.ShapeDetails_Insert, dynamicParameters, commandType: CommandType.StoredProcedure);
    ...
    public int UpdateShapeHeaderDetails(int UserID,UpdShapeHeaderDto obj)
    {
        try
        {
            int intReturnValue = 0;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                dynamicParameters.Add("@intUID", UserID);
                dynamicParameters.Add("@Output", 0);
                intReturnValue = sqlConnection.QueryFirstOrDefault<int>(SystemConstants.ShapeDetails_update, dynamicParameters, commandType: CommandType.StoredProcedure);
    ...
    public List<ChkShapeExistDto> CheckMeshShapeGroupExists(string meshShapeGroup)
    {
        try
        {
            IEnumerable<ChkShapeExistDto> chkShapeExists;
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
                var dynamicParameters = new DynamicParameters();
                dynamicParameters.Add("@meshShapeGroup", meshShapeGroup);
                chkShapeExists = sqlConnection.Query<ChkShapeExistDto>(SystemConstants.CheckMeshShapeGroupExists, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return chkShapeExists.ToList();
    ...
    public List<ChkShapeExistDto> CheckShapeExists(string shapeCode)
    {
        try
        {
            IEnumerable<ChkShapeExistDto> chkShapeExists;
            ...
            { 
                ...
                chkShapeExists = sqlConnection.Query<ChkShapeExistDto>(SystemConstants.CheckShapeExists, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return chkShapeExists.ToList();
    ...
    public List<GetAttributeDto> GetAttributes(int ShapeId)
    {
        try
        {
            IEnumerable<GetAttributeDto> getAttributeDtos;
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
                var dynamicParameters = new DynamicParameters();
                dynamicParameters.Add("@intShapeCode", ShapeId);
                getAttributeDtos = sqlConnection.Query<GetAttributeDto>(SystemConstants.ValidationParameters_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return getAttributeDtos.ToList();
    ...
    public List<GetAttributeDto> GetValidationConstraint(int ShapeId)
    {
        try
        {
            IEnumerable<GetAttributeDto> getAttributeDtos;
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                ...
                var dynamicParameters = new DynamicParameters();
                dynamicParameters.Add("@intShapeCode", ShapeId);
                getAttributeDtos = sqlConnection.Query<GetAttributeDto>(SystemConstants.Get_InsertedAttributes, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return getAttributeDtos.ToList();
    ...
    public int InsertIpOpValidationConstraints(GetAttributeDto getAttribute)
    {
        try
        {
            int intReturnValue = 0;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                var dynamicParameters = new DynamicParameters();
                sqlConnection.Open();
                //dynamicParameters.Add("@Id",Convert.ToInt32(getAttribute.Id));
                dynamicParameters.Add("@intShapeId", getAttribute.Fk_ShapeId);
                dynamicParameters.Add("@vchAttribute", getAttribute.Attribute);
                dynamicParameters.Add("@vchType", getAttribute.Type);
                dynamicParameters.Add("@vchValidationConstraint", getAttribute.ValidationConstraint);


                intReturnValue = sqlConnection.QueryFirstOrDefault<int>(SystemConstants.usp_InsertIpOpValidationConstraints, dynamicParameters, commandType: CommandType.StoredProcedure);
    ...
    public int UpdateIpOpValidationConstraints(GetAttributeDto getAttribute)
    {
        try
        {
            int intReturnValue = 0;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                intReturnValue = sqlConnection.QueryFirstOrDefault<int>(SystemConstants.usp_UpdateIpOpValidationConstraints, dynamicParameters, commandType: CommandType.StoredProcedure);
    ...
    public int DeleteIpOpValidationConstraints(int Id)
    {
        try
        {
            int intReturnValue = 0;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                dynamicParameters.Add("@Output", 0);
                sqlConnection.Query<int>(SystemConstants.usp_DeletIpOpValidationConstraints, dynamicParameters, commandType: CommandType.StoredProcedure);
                intReturnValue = dynamicParameters.Get<int>("@Output");
                sqlConnection.Close();
    ...
    public List<getFormulasDto> GetProductMArkingFormulas(int ShapeId)
    {
        try
        {
            IEnumerable<getFormulasDto>getFormulas;
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
                var dynamicParameters = new DynamicParameters();
                dynamicParameters.Add("@intShapeCode", ShapeId);
                getFormulas = sqlConnection.Query<getFormulasDto>(SystemConstants.Get_FromulaList, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return getFormulas.ToList();
    ...
    public List<getFormulasDto> GetProductMArkingFormulasById(string structElement)
    {
        try
        {
            IEnumerable<getFormulasDto> getFormulas;
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                sqlConnection.Open();
                var dynamicParameters = new DynamicParameters();
                dynamicParameters.Add("@strelementtype", structElement);
               
                getFormulas = sqlConnection.Query<getFormulasDto>(SystemConstants.Get_FromulaListbyStructEle, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return getFormulas.ToList();
    ...
    public List<getFormulasDto> GetLibraryId(string structElement,string FormulaName)
    {
        try
        {
            IEnumerable<getFormulasDto> getFormulas;
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                ...
                var dynamicParameters = new DynamicParameters();
                dynamicParameters.Add("@strelementtype", structElement);
                dynamicParameters.Add("@FormulaName", FormulaName);
                getFormulas = sqlConnection.Query<getFormulasDto>(SystemConstants.Get_LibraryID, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
                return getFormulas.ToList();
    ...
    public int InsertProductMArkingFormula(getFormulasDto getFormulasDto)
    {
        try
        {
            int intReturnValue = 0;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                sqlConnection.Open();
                //dynamicParameters.Add("@Id",Convert.ToInt32(getAttribute.Id));
                dynamicParameters.Add("Fk_LibraryId", getFormulasDto.LibraryId);
                dynamicParameters.Add("@Fk_ShapeId", getFormulasDto.Fk_shapeId);
                dynamicParameters.Add("@FormulaName", getFormulasDto.FormulaName);
                dynamicParameters.Add("@Formula", getFormulasDto.Formula);


                intReturnValue = sqlConnection.QueryFirstOrDefault<int>(SystemConstants.usp_InsertProductMarkingFormulae, dynamicParameters, commandType: CommandType.StoredProcedure);
    ...
    public int UpdateProductMArkingFormula(getFormulasDto getFormulasDto)
    {
        try
        {
            int intReturnValue = 0;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                var dynamicParameters = new DynamicParameters();
                sqlConnection.Open();
                dynamicParameters.Add("@Id", Convert.ToInt32(getFormulasDto.Id));
                dynamicParameters.Add("@Formula", getFormulasDto.Formula);


                intReturnValue = sqlConnection.QueryFirstOrDefault<int>(SystemConstants.usp_UpdateFormula, dynamicParameters, commandType: CommandType.StoredProcedure);
    ...
    public List<ChkShapeExistDto> GetAllShapeImage()
    {
        try
        {
            byte[] image = null;
            IEnumerable<ChkShapeExistDto> shapeImages;
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                shapeImages = sqlConnection.Query<ChkShapeExistDto>(SystemConstants.USP_GET_MESHSHAPE_IMAGE_ALL, dynamicParameters, commandType: CommandType.StoredProcedure);
                sqlConnection.Close();
