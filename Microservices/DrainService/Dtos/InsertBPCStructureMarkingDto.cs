...
{
    public class InsertBPCStructureMarkingDto
    {
        ...
        public bool bitAssembly{get;set;}
        ...
        public string vchPDFPath{get;set;}

        public int intCageDia { get;set;}
        public int intMachineTypeId { get; set; }
        public int vch3DImageRef { get; set; }
        public int vchBPCPdfPath { get; set; }
