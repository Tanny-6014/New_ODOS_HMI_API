    ...
    public class ShapeCode
    {
        ...
        public List<ShapeCode> ShapeCodeForBeam_Get()
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsShapeCodeForBeam = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ShapeCodeForBeam_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> FilterShapeCodeForBeam_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsShapeCodeForBeam = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.FilterShapeCodeForBeam_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> ColumnShapeCode_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsColumnShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ColumnShapeCode_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> ColumnShapeCodeBind_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsColumnShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ColumnShapeCodeBind_Get, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> SlabShapeCode_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsSlabShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.SlabShapeCode_Get, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> SlabShapeCodeFilter_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsSlabShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.SlabShapeCodeFilter_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> CarpetShapeCode_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCarpetShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.SlabShapeCode_Get, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> CarpetShapeCodeFilter_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCarpetShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.SlabShapeCodeFilter_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> CapShapeCode_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCapShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ShapeCode_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> ShapeCodeNoFilter_Get()
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCapShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ShapeCodeNoFilter_Get, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> CLinkShapeCode_Get(string enteredText)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCLinkShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ShapeCode_Get_Clink, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> ClinkShapeCodeNoFilter_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCLinkShapeCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ShapeCodeNoFilter_Get_Clink, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> ShapeCodeDetailsforIrregularSpacing_Get(int ProductMarkId, string StructureElementType)
        {
            try
            {
                ...
                {
                    sqlConnection.Open();
                    SqlCommand cmd = new SqlCommand(SystemConstants.ShapeCodeDetailsByProductMarkId_Get, sqlConnection);
                    ...
                    //detailIrregularSpacDtos = sqlConnection.Query<ShapeDetailIrregularSpacDto>(SystemConstants.ShapeCodeDetailsByProductMarkId_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> FilterShapeCodeForCab_Get(string enteredText)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsShapeCodeForCab = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.FILTERSHAPECODEFORCAB_GET, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ShapeCode> AllShapeCodeForCab_Get()
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsShapeCodeForCab = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.allcabshapecodes_get, commandType: CommandType.StoredProcedure);
