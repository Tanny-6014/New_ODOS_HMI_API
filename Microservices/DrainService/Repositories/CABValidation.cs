...
namespace DrainService.Repositories
{
    ...
    //                sb = sb.Append("select intSEDetailingId from cabproductmarkingdetails where intSEDetailingId = " + this.intSEDetailingId.ToString() + " and vchCABProductMarkName = '" + this.BarMarkId + "'");
