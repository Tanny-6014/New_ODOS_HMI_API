...
namespace DrainService.Repositories
{
    public class ProductCode
    {
        ...
        private string connectionString = "Server=NSQADB5\\MSSQL2022;Database=ODOS;TrustServerCertificate=True;MultipleActiveResultSets=true;User=MES_USER;Password=Mes@123";
        ...
        public List<ProductCode> ProductCodeForBeam_Get(int StructureElementTypeId, int ProductTyprId)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    beamProductCodeListDto = sqlConnection.Query<BeamProductCodeListDto>(SystemConstants.ProductCodeForBeam_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> FilterProductCodeForBeam_Get(int StructureElementTypeId, int ProductTyprId, string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsProductCodeForBeam = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.FilterProductCodeForBeam_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> CapProductForBeam_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    sqlConnection.Open();
                    var dynamicParameters = new DynamicParameters();
                    beamCapProductDto = sqlConnection.Query<BeamCapProductDto>(SystemConstants.CapProductForBeam_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> FilterCapProductForBeam_Get(string enteredText)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCapProductForBeam = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.FilterCapProductForBeam_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> ColumnProductCode(int StructureElementTypeId, int ProductTypeId, string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsColumnProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ColumnProductCode_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> ColumnProductCodeBind(int StructureElementTypeId, int ProductTypeId)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsColumnProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ColumnProductCodeBind_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> ColumnCLinkProductLength_Get(string enteredText)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsColumnClinkProductCodelength = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ColumnCLinkProduct_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> ColumnCLinkProducttLengthBind_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsColumnClinkProductCodelength = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ColumnCLinkProductBind_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> SlabProductCode()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsSlabProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.SlabProductCode_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> SlabProductCodeFilter(string enteredText)
        {
            ...
            List<ProductCode> listSlabProductCode = new List<ProductCode> { };
            IEnumerable<SlabProductCodeFilter_Get> IESlabProductCode;
            DataSet dsSlabProductCode = new DataSet();
...

            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    IESlabProductCode = sqlConnection.Query<SlabProductCodeFilter_Get>(SystemConstants.SlabProductCodeFilter_Get, dynamicParameters, commandType: CommandType.StoredProcedure);

                    if (IESlabProductCode.Count() > 0)
                    {
                        DataTable dt = ConvertToDataTable.ToDataTable(IESlabProductCode);
        ...
        public List<ProductCode> CarpetProductCode()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCarpetProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.CarpetProductCode_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> CarpetProductCodeFilter(string enteredText)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCarpetProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.CarpetProductCodeFilter_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> CapProductCode_Get(string enteredText)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCapProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.CapProductCode_Cache_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> CapProductCodeNoFilter_Get()
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCapProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.CapProductCodeNoFilter_Cache_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> ClinkProductCode_Get(string enteredText)
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsClinkProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ClinkProductCode_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public List<ProductCode> CLinkProductCodeNoFilter_Get()
        {
            ...
            try
            {
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsCLinkProductCode = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.ClinkProductCodeNoFilter_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
