        ...
        public List<Accessory> GetACCProductMarkDetailsBySEDetailingID(int intSEDetailingID)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dsSlabStructureMark = (DataSet)sqlConnection.Query<DataSet>(SystemConstants.Accessories_Get, dynamicParameters, commandType: CommandType.StoredProcedure);
        ...
        public bool Save(out string errorMessage)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    dynamic result = sqlConnection.Query<int>(SystemConstants.Accessories_Insert, dynamicParameters, commandType: CommandType.StoredProcedure).SingleOrDefault();
        ...
        public bool Delete(out string errorMessage)
        {
            ...
            try
            {
                ...
                using (var sqlConnection = new SqlConnection(connectionString))
                {
                    ...
                    Postedvalidate = sqlConnection.Query<int>(SystemConstants.Accessories_Delete, dynamicParameters, commandType: CommandType.StoredProcedure);
