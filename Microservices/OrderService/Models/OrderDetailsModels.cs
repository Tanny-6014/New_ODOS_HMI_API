...
namespace OrderService.Models
{
    ...
    public class OrderDetailsModels
    {
        ...
        public bool? isVariousBarFlag { get; set; }

        public OrderDetailsModels ShallowCopy()
        {
            return (OrderDetailsModels)this.MemberwiseClone();
        }
    }

    public class OrderDetailsListModels
    {
        [Key, Column(Order = 1)]
        public string CustomerCode { get; set; }
        [Key, Column(Order = 2)]
    ...
    public class OrderDetailsRetModels
    {
        public string CustomerCode { get; set; }
        public string ProjectCode { get; set; }
        public int JobID { get; set; }
    ...
    [Table("OESOrderDetailsDouble")]
    public class OrderDetailsDoubleModels
    {
        [Key, Column(Order = 1)]
        public string CustomerCode { get; set; }
        [Key, Column(Order = 2)]
