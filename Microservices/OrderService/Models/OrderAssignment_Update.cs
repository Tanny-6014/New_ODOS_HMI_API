...
{
    public class OrderAssignment_Update
    {
        ...
        public ExtendedHeader_U Extended { get; set; }
        public List<Item_U> Items { get; set; }
    }

    public class ExtendedHeader_U
    {
        ...
        public DateTimeOffset? FirstPromisedDate { get; set; }
    ...
    public class Item_U
    {
        ...
        public ExtendedItem_U Extended { get; set; }
    }

    public class ExtendedItem_U
    {
