...
namespace OrderService.Models
{
    ...
    public class BPCDetailsModels
    {
        ...
        public int? cr_posn_top { get; set; }

        public int? cr_posn_end { get; set; }

        public string cr_top_remarks { get; set; }

        public string  pdf_remark{ get; set; }

        public string? vchCustomizeBarsJSON { get; set; }

        public int? lminTop { get; set; }

        public int? lminEnd { get; set; }

        public string? cr_ring_type { get; set; }

        public string? cr_bundle_side { get; set; }
        public string? mainbar_position_2layer { get; set; }
        public string? BPC_Type {  get; set; }

        public int? cr_link_lapping { get; set; } = 51;
        public int? sr_link_lapping { get; set; } = 10;

        public byte[] ? ElevatedView { get; set; }

        public byte[] ? PlanView { get; set; }

        public string ? twopcs_stiffener { get; set; }
