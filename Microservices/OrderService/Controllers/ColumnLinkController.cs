...
{
   // [Authorize]
    public class ColumnLinkController : Controller
    {
        ...
        //download PO doc 
        [HttpPost]
        [Route("/deletePODocs_column/{CustomerCode}/{ProjectCode}/{JobID}/{PODocID}")]
        //[ValidateAntiForgeryHeader]
        ...
        //download PO doc 
        [HttpPost]
        [Route("/downloadPODocs_column/{CustomerCode}/{ProjectCode}/{JobID}/{PODocID}")]
        //[ValidateAntiForgeryHeader]
        ...
        //check PO doc 
        [HttpPost]
        [Route("/checkPODocs_column/{CustomerCode}/{ProjectCode}/{JobID}")]
        // [ValidateAntiForgeryHeader]
        ...
        [HttpGet]
        [Route("/getVarMaxValue_column/{pValue}")]
        ...
        [HttpGet]
        [Route("/getVarMinValue_column/{pValue}")]
        ...
        [HttpGet]
        [Route("/isInvalidParameterCell_column/{pShapeCode}/{pColumnName}/{pParameters}")]
        ...
        [HttpGet]
        [Route("/calTotalLen_column/{pItem}/{pshapeLengthFormula}/{pValue}")]
        ...
        [Route("/ExcelImport_column/{CustomerCode}/{ProjectCode}/{JobID}/{BBSID}")]
        ...
        [HttpPost]
        [Route("/getWBS1_column/{ProjectCode}")]
        //[ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        [Route("/getWBS2_column/{ProjectCode}/{WBS1}")]
        //[ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        [Route("/getWBS3_column/{ProjectCode}/{WBS1}/{WBS2}")]
        //[ValidateAntiForgeryHeader]
        ...
        //[HttpGet]  delete after sometime
        //[Route("/RemoveNonMESHProject_Oracle_column/{pInputProj}")]
        ...
        [HttpGet]
        [Route("/RemoveNonMESHProject_column/{pInputProj}")]
        ...
        //            try
        //            {
        //                var lTotalWT = await (from p in db.CTSMESHColumnDetails
        //                                      where p.CustomerCode == CustomerCode &&
        //                                      p.ProjectCode == ProjectCode &&
        //                                      p.JobID == JobID &&
        //                                      p.BBSID == 1
        ...
        //                var lTotalPCs = await (from p in db.CTSMESHColumnDetails
        //                                       where p.CustomerCode == CustomerCode &&
        //                                       p.ProjectCode == ProjectCode &&
        //                                       p.JobID == JobID &&
        //                                       p.BBSID == 1
        ...
        [HttpGet]
        [Route("/getColumnDetailsNSH_column/{CustomerCode}/{ProjectCode}/{PostID}")]
        public ActionResult getColumnDetailsNSH(string CustomerCode, string ProjectCode, int PostID)
        {
            ...
            if (PostID > 0)
            {
                ...
                if (lProcessObj.OpenNDSConnection(ref lNDSCon) == true)
                {
                    ...
                    "P.intInvoiceMWQty, " +
                    "P.numInvoiceCWLength, " +
                    "P.intLinkQty * tntGroupQty as TotalQty, " +
                    "S.intRowsAtLength, " +
                    "(select isNull(vchProductCode, '') " +
                    "FROM dbo.ProductCodeMaster " +
                    "WHERE intProductCodeId = S.intClinkProductCodeIdAtLength " +
                    ...
                    ") as CLinkProductCodeAtLength, " +
                    "P.ParamValues, " +
                    "P.numTheoraticalWeight * P.intLinkQty * tntGroupQty as InvoiceWeight, " +
                    "(STUFF((SELECT CAST(',' + rtrim(chrParamName) AS VARCHAR(MAX)) " +
                    "FROM dbo.ShapeParamDetails " +
                    "WHERE(intShapeID = P.intShapeCodeId) " +
                    "AND (bitEdit = 1 or bitVisible = 1) " +
        ...
        //        [ValidateAntiForgeryHeader]
        [HttpGet]
        [Route("/getMeshColumnDetails_column/{CustomerCode}/{ProjectCode}/{JobID}/{BBSID}")]
                    ...
                    if (lRst.HasRows)
                    {
                        while (lRst.Read())
                        {
                            lNewColumn = new CTSShapeColumnDetailsModels
                            {
                                ...
                                ProdMaxFactor = lRst.GetValue(41) == DBNull.Value ? null : (int?)lRst.GetInt32(41),
                                ProdTwinInd = lRst.GetValue(42) == DBNull.Value ? "" : lRst.GetString(42).Trim(),
                                MWLength = lRst.GetValue(43) == DBNull.Value ? null : (int?)lRst.GetInt32(43),
                                MWBOM = lRst.GetValue(44) == DBNull.Value ? "" : lRst.GetString(44).Trim(),
                                CWBOM = lRst.GetValue(45) == DBNull.Value ? "" : lRst.GetString(45).Trim(),
                                SplitNotes = lRst.GetValue(46) == DBNull.Value ? "" : lRst.GetString(46).Trim()
                            };
        ...
        //        [HttpPost]
        //        [ValidateAntiForgeryHeader]
        //        public ActionResult getCLProductCode()
        //        {
        //            var lCLProduct = "";
        //            var lCmd = new SqlCommand();
        //            var lNDSCon = new SqlConnection();
        ...
        //                        {
        //                            lCLProduct = lCLProduct + "," + lMeshProductCode.Trim();
        //                        }
        //                    }
        //                }
        //                lRst.Close();
        ...
        //            return Json(lCLProduct, JsonRequestBehavior.AllowGet);
        //        }
        ...
        //        [HttpPost]
        //        [ValidateAntiForgeryHeader]
        //        public async Task<ActionResult> saveMeshColumnDetails(CTSMESHColumnDetailsModels pColumnDetails)
        //        {
        ...
        //                var oldBar = await db.CTSMESHColumnDetails.FindAsync(pColumnDetails.CustomerCode, pColumnDetails.ProjectCode, pColumnDetails.JobID, pColumnDetails.BBSID, pColumnDetails.MeshID);
        //                if (oldBar == null)
        //                {
        ...
        //        //getShapeImagesByCat
        [HttpGet]
        [Route("/getShapeImagesByCat_column/{ShapeCategory}")]
        //[ValidateAntiForgeryHeader]
        ...
        [HttpGet]
        [Route("/getProductList_column/{ProductCategory}")]
        //[ValidateAntiForgeryHeader]
        ...
        //                            lTrinInd = lRst.GetValue(8) == DBNull.Value ? "" : lRst.GetString(8).Trim();
        //                        }
        //                    }
        //                    lRst.Close();
        ...
        //        //Print Shapes List 
        [HttpPost]
        [Route("/printShapes_column/{ShapeCategory}")]
        //[ValidateAntiForgeryHeader]
        ...
        //        //Print Shapes List 
        [HttpPost]
        [Route("/printProduct_column/{ProductCategory}")]
        //[ValidateAntiForgeryHeader]
