...
namespace OrderService.Controllers
{
    ...
    public class StandardMESHController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        [Route("/getProjectCategorey_mesh/{appCustomerCode}/{appProjectCode}/{Username}/{appProductType}/{appStructureElement}/{appScheduledProd}/{appWBS1}/{appWBS2}/{appWBS3}/{appOrderNo}/{PostID}")]
        public ActionResult getProjectCategorey_mesh(string appCustomerCode, string appProjectCode, string Username, string appProductType,string appStructureElement, string appScheduledProd, string appWBS1, string appWBS2, string appWBS3, string appOrderNo, int PostID)
        {
        ...
        //    if (lUserType == "")
        //    {
        //       // return RedirectToAction("Index", "Home"); ..VW
        //    }
        ...
        [HttpGet]
        //[ValidateAntiForgeryHeader]
        [Route("/getStdSheetsBySeries/{SeriesCode}")]
        public ActionResult getStdSheetsBySeries(string SeriesCode)
        {
            ...
            try
            {
                lReturn = (from p in db.StdSheetMaster
                           ...
                           p.oes_order == 1
                           orderby p.mw_size descending, p.mw_spacing, p.unit_weight
                           select p).ToList();
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        //  [ValidateAntiForgeryHeader]
        [Route("/getStandardProducts/{ProdCategory}")]
        ...
        [HttpPost]
        //[ValidateAntiForgeryHeader]
        [Route("/checkOrderStatus_mesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        public ActionResult checkOrderStatus(string CustomerCode, string ProjectCode, int JobID)
        {
                ...
                lCheckJob.UpdateBy != User.Identity.GetUserName()))
            {
                ...
                {
                    return Ok(lCheckStdDet);
                    //return ok commented by vw
                    //return Json(new
                    //{
                    //    success = false,
                    //    error = true,
            ...
            return Ok(lCheckStdDet);  //added by vishal wani
        }
       ...
       // [ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        //  [ValidateAntiForgeryHeader]
        [Route("/downloadPODocs_mesh/{CustomerCode}/{ProjectCode}/{JobID}/{PODocID}")]
        ...
        [HttpPost]
        //  [ValidateAntiForgeryHeader]
        [Route("/checkPODocs_mesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        ...
        [HttpPost]
        // [ValidateAntiForgeryHeader]
        [Route("/sendOrderSubmittedEmail_mesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        ...
        //[HttpPost]
        //// [ValidateAntiForgeryHeader]
        //[Route("/getProject_mesh/{CustomerCode}")]
        ...
        //[Route("/RemoveNonMESHProject_Oracle")]
        ...
        [HttpGet]
        [Route("/RemoveNonMESHProject_mesh")]
        ...
        [HttpGet]
        //[ValidateAntiForgeryHeader]
        [Route("/getProjectDetails_mesh/{CustomerCode}/{ProjectCode}/{UserName}")]
            ...
            if (lProcessObj.OpenNDSConnection(ref lNDSCon) == true)
            {
                ...
                if (lRst.HasRows)
                {
                    if (lRst.Read())
                    {
                        ...
                        {
                            CustomerCode = lRst.GetValue(0) == DBNull.Value || lRst.GetString(0) == "0000000000" ? CustomerCode : lRst.GetString(0).Trim(),
        ...
        public ActionResult getProductTypeList()
        {
            ...
            "FROM dbo.OESStdProdType WHERE ProdTypeCode = '1' OR ProdTypeCode = '2' OR ProdTypeCode = '3' OR " +
            "ProdTypeCode = '4' OR ProdTypeCode = '5' OR ProdTypeCode = '6'  OR ProdTypeCode = '7'  OR " +
            "ProdTypeCode = '8' OR ProdTypeCode = '9' OR ProdTypeCode = 'A' " +
        ...
        //[HttpPost]
        ////[ValidateAntiForgeryHeader]
        //[Route("/getOrderList_mesh/{CustomerCode}/{ProjectCode}")]
        ...
        //[Route("/updateOrderStatus_mesh/{pCustomerCode}/{pProjectCode}")]
        ...
        [HttpGet]
        [Route("/createJobAdvice_mesh/{pCustomerCode}/{pProjectCode}/{pClone}")]
                    ...
                    if (lUserType == "CU" || lUserType == "CA" || lUserType == "PL" || lUserType == "AD" || lUserType == "PM" || lUserType == "PA" || lUserType == "P1" || lUserType == "P2" || lUserType == "PU")
                    {
                        ...
                        if (lEditable == "Yes")
                        {
                            ...
                            if (lFound == 0)
                            {
                                ...
                                var lProj = (from p in db.Project
        ...
        [HttpPost]
        // [ValidateAntiForgeryHeader]
        [Route("/getOrderListSearch_mesh/{CustomerCode}/{ProjectCode}/{RequiredDateFrom}/{RequiredDateTo}/{PONo}")]
        ...
        [HttpPost]
        //  [ValidateAntiForgeryHeader]
        [Route("/getOrderDetails_mesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        ...
        [HttpPost]
        //   [ValidateAntiForgeryHeader]
        [Route("/setCloneOrder_mesh/{CustomerCode}/{ProjectCode}/{JobID}/{CloneNo}")]
        public ActionResult setCloneOrder(string CustomerCode, string ProjectCode, int JobID, int CloneNo)
        {
            ...
            try
            {
                ...
                return Ok(); //added by vishal wani
        ...
        [HttpGet]
        //  [ValidateAntiForgeryHeader]
        [Route("/SaveJobAdvice_mesh/{CustomerCode}/{ProjectCode}/{JobID}/{OrderStatus}/{TotalPcs}/{TotalWeight}")]
        ...
        [HttpPost]
        //  [ValidateAntiForgeryHeader]
        [Route("/OrderWithdraw_mesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        ...
        [HttpGet]
        //[ValidateAntiForgeryHeader]
        [Route("/getBBS_mesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        public ActionResult getBBS(string CustomerCode, string ProjectCode, int JobID)
        {

            var contentMESH = (from p in db.StdSheetDetails
                               where p.CustomerCode == CustomerCode &&
                               p.ProjectCode == ProjectCode &&
                               p.JobID == JobID
                               orderby p.SheetSort
            ...
            return Ok(contentMESH);
          //  return Json(new { STDMESH = contentMESH, STDPROD = contentStd }, JsonRequestBehavior.AllowGet);
        }
        ...
        // [ValidateAntiForgeryHeader]
        [Route("/saveBBS_mesh")]
        public ActionResult saveBBS([FromBody] stdSheetProd StdProd)
        {
            string Message="";
            var lErrorMsg = "";
            try
            {
                var StdProdModels = new List<StdSheetDetailsModels>();

                db.Database.ExecuteSqlCommand("DELETE FROM OESStdSheetDetails " +
                ...
                if (StdProd.StdProdDetails != null && StdProd.StdProdDetails.Count > 0)
                {
                    ...
                    {
                        StdProd.StdProdDetails[i].SheetID = i + 1;
                        ...
                        StdProd.StdProdDetails[i].JobID = StdProd.JobID;
                        db.StdSheetDetails.Add(StdProd.StdProdDetails[i]);
                    }
                }
        ...
        [HttpPost]
        //[ValidateAntiForgeryHeader]
        [Route("/ValidatePONumber_mesh/{CustomerCode}/{ProjectCode}/{JobID}/{PONumber}")]
        ...
        //get Bars List 
        [HttpPost]
        [Route("/printOrderDetail_mesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        // [ValidateAntiForgeryHeader]
