...
{
    //[Authorize]
    public class CTSMESHController : Controller
    {
        ...
        public ActionResult Index_old()
        {
            ...
            //var lProjectCK = Request.Cookies["nsh_digios_proj"]; vw
            var lProjectCK = "";
            if (lProjectCK != null)
            {
        ...
        string appOrderNo, string appWBS1, string appWBS2, string appWBS3)
        {
            //appScheduledProd:
            //Y - NDS select;
            //N - order from product directly
            //E - Component edit;
            //S - order from component directly
            //W - order from component WBS
            ...
            string lOrderTransport = "TR40/24";
            ...
            else
            {
                ...
                if (lComp != null)
                {
                    ...
                    lOrderTransport = lComp.TransportMode;
            ...
            ViewBag.ProductType = appProductType;
        ...
        [HttpGet]
        [Route("/isInvalidParameterCell_ctsmesh")]
        ...
        //            if (lUserType == "AD" || lUserType == "PM" || lUserType == "PL" || lUserType == "PA" || lUserType == "P1" || lUserType == "P2" || lUserType == "PU" || lUserType == "TE")
        //            {
        //                #region Get from SAP
        ...
        //[HttpGet]
        //[Route("/RemoveNonMESHProject_Oracle_ctsmesh")]
        ...
        [HttpGet]
        [Route("/RemoveNonMESHProject_ctsmesh")]
        ...
        //        [HttpPost]
        //        [Route("/checkOrderStatus_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //            var lCheckJob = db.CTSMESHJobAdvice.Find(CustomerCode, ProjectCode, JobID);
        ...
        //        //[HttpPost]
        //        //[ValidateAntiForgeryHeader]
        ////        public ActionResult getProjectDetails(string CustomerCode, string ProjectCode)
        ////        {
        ////            var lCmd = new SqlCommand();
        ////            SqlDataReader lRst;
        ////            var lNDSCon = new SqlConnection();
        ...
        //        [HttpPost]
        //        [Route("/getDeliveryAddress_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        [HttpPost]
        //        [Route("/getCopyOrderList_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        [HttpGet]
        //        [Route("/updateOrderStatus_ctsmesh")]
        ...
        //        [HttpPost]
        //        [Route("/getOrderListSearch_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        [HttpGet]
        [Route("/UpdateSUM_ctsmesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        //[ValidateAntiForgeryHeader]
        public ActionResult UpdateSUM(string CustomerCode, string ProjectCode, int JobID)
        {
            ...
            try
            {
                var lTotalWT = (from p in db.CTSMESHOthersDetails
                                where p.CustomerCode == CustomerCode &&
                                p.ProjectCode == ProjectCode &&
                                p.JobID == JobID &&
                                p.BBSID == 1
                ...
                var lTotalPCs = (from p in db.CTSMESHOthersDetails
                                 where p.CustomerCode == CustomerCode &&
                                 p.ProjectCode == ProjectCode &&
                                 p.JobID == JobID &&
                                 p.BBSID == 1
                ...
                if (oldJobAdvice != null)
                {
                    ...
                    var oldBBS = db.CTSMESHBBS.Find(CustomerCode, ProjectCode, JobID, 1);
                    var lNewBBS = oldBBS;
                    ...
                    var lComponent = (from p in db.OESComponent
                                      where p.MeshJobID == JobID &&
                    ...
                    if (lComponent != null && lComponent.Count > 0)
                    {
                        ...
                        if (lCompID > 0)
                        {
                            var lOldCOM = db.OESComponent.Find(lCompID);
                            if (lOldCOM != null)
                            {
                                var lNewCOM = lOldCOM;
                    ...
                    int lRtn = db.SaveChanges();


                    return Ok(lNewJobAdv.JobID);
                }
                else
                {
                    return Ok();
        ...
        //        [HttpPost]
        //        [Route("/SaveJobAdvice_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        //        public ActionResult SaveJobAdvice(CTSMESHJobAdviceModels jobAdviceModels)
        //        {
        //            var lErrorMsg = "";
        //            int? lJobID = 0;
        //            try
        ...
        //                if (jobAdviceModels.AutoWBS == true)
        //                {
        //                    jobAdviceModels.WBS1 = "";
        //                    jobAdviceModels.WBS2 = "";
        //                    jobAdviceModels.WBS3 = "";
        //                }
        ...
        //                    {
        //                        lJobID = db.CTSMESHJobAdvice.Where(z => z.CustomerCode == jobAdviceModels.CustomerCode &&
        ...
        //                    var oldJobAdvice = db.CTSMESHJobAdvice.Find(jobAdviceModels.CustomerCode, jobAdviceModels.ProjectCode, jobAdviceModels.JobID);
        //                    if (oldJobAdvice == null)
        //                    {
        //                        db.CTSMESHJobAdvice.Add(jobAdviceModels);
        //                    }
        //                    else
        //                    {
        ...
        //        //List of Used BBS No
        //        [HttpPost]
        //        [Route("/ExportPONoToExcel_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        [HttpGet]
        //        [Route("/ExcelSheetGenerationPO_ctsmesh")]
        ...
        //        //List of Used BBS No
        //        [HttpPost]
        //        [Route("/ExportBBSNoToExcel_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        [HttpGet]
        //        [Route("/ExcelSheetGeneration_ctsmesh")]
        ...
        //        [HttpGet]
        //        [Route("/checkUpdateBBSWT_ctsmesh")]
        ...
        [HttpGet]
        [Route("/getBBSCust_ctsmesh/{CustomerCode}/{ProjectCode}/{JobID}")]
        //[ValidateAntiForgeryHeader]
        ...
        //        //ValidatePONumber
        //        [HttpPost]
        //        [Route("/ValidatePONumber_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        [HttpPost]
        //        [Route("/getBeamDetailsNSH_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        //        public ActionResult getBeamDetailsNSH(string CustomerCode, string ProjectCode, int JobID, int BBSID, int BBSPostID)
        //        {
        ...
        //        [HttpPost]
        //        [Route("/getColumnDetailsNSH_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        //get Column Link Cage List 
        [HttpGet]
        [Route("/getOthersDetailsNSH_ctsmesh/{CustomerCode}/{ProjectCode}/{PostID}")]
        //[ValidateAntiForgeryHeader]
        public ActionResult getOthersDetailsNSH(string CustomerCode, string ProjectCode, int PostID)
        {
        ...
        //        //getOthersDetailsNSH
        [HttpPost]
        [Route("/getMeshBeamDetails_ctsmesh")]
        //[ValidateAntiForgeryHeader]
                    ...
                    if (lRst.HasRows)
                    {
                        while (lRst.Read())
                        {
                            lNewBeam = new CTSShapeBeamDetailsModels
                            {
                                ...
                                MeshTotalWT = lRst.GetValue(26) == DBNull.Value ? null : (int?)lRst.GetDecimal(26),
        ...
        //        [HttpPost]
        //        [Route("/getMeshColumnDetails_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        //        public ActionResult getMeshColumnDetails(string CustomerCode, string ProjectCode, int JobID, int BBSID)
        //        {
        //            var lColumnDetails = new List<CTSShapeColumnDetailsModels>();
        //            var lNewColumn = new CTSShapeColumnDetailsModels();
        ...
        //                "M.intMinLinkFactor, " +
        //                "M.chrTwinIndicator " +
        //                "FROM dbo.OESCTSMESHColumnDetails D " +
        //                "LEFT OUTER JOIN dbo.ProductCodeMaster M " +
        //                "ON D.MeshProduct = M.vchProductCode " +
        //                "WHERE CustomerCode = '" + CustomerCode + "' " +
        //                "AND ProjectCode = '" + ProjectCode + "' " +
        ...
        //                        while (lRst.Read())
        //                        {
        //                            lNewColumn = new CTSShapeColumnDetailsModels
        //                            {
        //                                CustomerCode = lRst.GetString(0).Trim(),
        //                                ProjectCode = lRst.GetString(1).Trim(),
        //                                JobID = lRst.GetInt32(2),
        ...
        //        //get Mesh List 
        //        [HttpPost]
        //        [Route("/getMeshStdSheetDetails_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        //get Mesh List 
        [HttpGet]
        [Route("/getMeshOtherDetails_ctsmesh/{CustomerCode}/{ProjectCode}/{JobID}/{BBSID}")]
        //[ValidateAntiForgeryHeader]
        public ActionResult getMeshOtherDetails(string CustomerCode, string ProjectCode, int JobID, int BBSID)
        {
            var lOthersDetails = new List<CTSShapeOthersDetailsModels>();
            var lNewColumn = new CTSShapeOthersDetailsModels();
            ...
            if (BBSID > 0)
            {
                ...
                "MWBOM, " +
                "CWBOM " +
                "FROM dbo.OESCTSMESHOthersDetails D " +
                "LEFT OUTER JOIN dbo.ProductCodeMaster M " +
                "ON D.MeshProduct = M.vchProductCode " +
                "WHERE CustomerCode = '" + CustomerCode + "' " +
                "AND ProjectCode = '" + ProjectCode + "' " +
                ...
                if (lProcessObj.OpenNDSConnection(ref lNDSCon) == true)
                {
                    ...
                    if (lRst.HasRows)
                    {
                        while (lRst.Read())
                        {
                            lNewColumn = new CTSShapeOthersDetailsModels
                            {
                                CustomerCode = lRst.GetString(0).Trim(),
                                ProjectCode = lRst.GetString(1).Trim(),
                                JobID = lRst.GetInt32(2),
                                ...
                                MWBOM = lRst.GetValue(59) == DBNull.Value ? "" : lRst.GetString(59).Trim(),
                                CWBOM = lRst.GetValue(60) == DBNull.Value ? "" : lRst.GetString(60).Trim()
                            };
        ...
        //        //get Mesh List 
        //        [HttpPost]
        //        [Route("/getBeamProductCode_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        [HttpPost]
        //        [Route("/getColumnProductCode_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        [HttpGet]
        [Route("/getOthersProductCode_ctsmesh")]
        //[ValidateAntiForgeryHeader]
        ...
        //        //get Beam shape List 
        //        [HttpPost]
        //        [Route("/getBeamShapeCode_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        [HttpPost]
        //        [Route("/getColumnShapeCode_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        [HttpGet]
        [Route("/getOthersShapeCode_ctsmesh/{UserName}")]
        //[ValidateAntiForgeryHeader]
        public ActionResult getOthersShapeCode(string UserName)
        {
            //string lUserName = User.Identity.GetUserName();
            ...
            if (lProcessObj.OpenNDSConnection(ref lNDSCon) == true)
            {
                var lUserNameA = lUserName.Split('@');
                if (lUserNameA.Length == 2 && lUserNameA[1] != null && lUserNameA[1].ToLower() == "natsteel.com.sg")
                {
                    lCmd.CommandText =
                    "SELECT chrShapeCode " +
                    "FROM dbo.ShapeMaster " +
        ...
        //        [HttpPost]
        //        [Route("/saveMeshBeamDetails_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        //        public ActionResult saveMeshBeamDetails(CTSMESHBeamDetailsModels pBeamDetails)
        //        {
        ...
        //                var oldBar = db.CTSMESHBeamDetails.Find(pBeamDetails.CustomerCode, pBeamDetails.ProjectCode, pBeamDetails.JobID, pBeamDetails.BBSID, pBeamDetails.MeshID);
        //                if (oldBar == null)
        //                {
        ...
        //        [HttpPost]
        //        [Route("/saveMeshColumnDetails_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        //[ValidateAntiForgeryHeader]
        [Route("/saveMeshStdSheetDetails_ctsmesh")]
        public ActionResult saveMeshStdSheetDetails(List<CTSMESHStdSheetDetailsModels> pStdSheetDetails)
        {
            ...
            //return Ok(new { success = false, responseText = lErrorMsg }, JsonRequestBehavior.AllowGet);
            return Ok();
        }

        //        //save Mesh - Standard Sheet
        [HttpPost]
        [Route("/saveMeshOthersDetails_ctsmesh")]
        //[ValidateAntiForgeryHeader]
        public async Task<ActionResult> saveMeshOthersDetails([FromBody] CTSMESHOthersDetailsModels pOthersDetails)
        {
            ...
            if (pOthersDetails.CustomerCode.Length > 0)
            {
                ...
                var oldBar = await db.CTSMESHOthersDetails.FindAsync(pOthersDetails.CustomerCode, pOthersDetails.ProjectCode, pOthersDetails.JobID, pOthersDetails.BBSID, pOthersDetails.MeshID);
                if (oldBar == null)
                {
        ...
        //        // delete mesh beam
        //        [HttpPost]
        //        [Route("/deleteMeshBeamDetails_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        // delete mesh column
        //        [HttpPost]
        //        [Route("/deleteMeshColumnDetails_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        [HttpPost]
        //        [Route("/deleteMeshStdSheetDetails_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        // delete a standrad sheet reord
        [HttpGet]
        [Route("/deleteMeshOthersDetails_ctsmesh/{CustomerCode}/{ProjectCode}/{JobID}/{BBSID}/{MeshID}")]
        //[ValidateAntiForgeryHeader]
        ...
        [HttpGet]
        //[ValidateAntiForgeryHeader]
        [Route("/getShapeImagesByCat/{ShapeCategory}")]
        ...
        //        //get product information 
        [HttpGet]
        [Route("/getProductInfo_ctsmesh/{ProductCode}")]
        //[ValidateAntiForgeryHeader]
        ...
        [HttpGet]
        //[ValidateAntiForgeryHeader]
        [Route("/getShapeInfo_ctsmesh/{CustomerCode}/{ProjectCode}/{JobID}/{ShapeCode}")]
        ...
        //        //get shape List 
        [HttpGet]
        [Route("/getShapeCodeList_ctsmesh/{CustomerCode}/{ProjectCode}/{CouplerType}")]
        //[ValidateAntiForgeryHeader]
        ...
        //        //get shape List 
        //        [HttpPost]
        //        [Route("/getCustomerShapeCodeList_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //        //Print Shapes List 
        //[HttpGet]
        //[Route("/printShapes_ctsmesh/{ShapeCategory}")]
        ////[ValidateAntiForgeryHeader]
        ...
        //        //get MESH List 
        //        [HttpPost]
        //        [Route("/printOrderDetail_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
        ...
        //                                "dbo.WBSElementsDetails D, dbo.ProjectMaster P, " +
        ...
        //        //get BBS List at Order Summary
        //        [HttpPost]
        //        [Route("/getScheduleData_old_ctsmesh")]
        //        //[ValidateAntiForgeryHeader]
