...
namespace OrderService.Controllers
{
    ...
    public class StandardBarController : Controller
    {
...
//        [HttpGet]
//        [Route("/Index")]
//        public ActionResult Index(string appCustomerCode, string appProjectCode,
//        string appStructureElement, string appProductType, string appScheduledProd, 
//        string appOrderNo)
//        {
...
//            //ViewBag.AllowGrade500M = (lProjectDetail.AllowGrade500M == null ? false : lProjectDetail.AllowGrade500M);
//            //TempData["CustomerBar"] = (lProjectDetail.CustomerBar == null ? "" : lProjectDetail.CustomerBar);
...
//        }
        ...
        [HttpGet]
        [Route("/getProjectCategorey/{appCustomerCode}/{appProjectCode}/{UserName}")]
        public ActionResult getProjectCategorey(string appCustomerCode, string appProjectCode,string UserName)
        {
            UserAccessController lUa = new UserAccessController();
            ...
            var lProjectDetail = (from p in db.Project
                                  where p.CustomerCode == appCustomerCode &&
                                  p.ProjectCode == appProjectCode 
                                  select p
                       ).ToList();

            return Ok(lProjectDetail);
        }


        [HttpGet]
        //[ValidateAntiForgeryHeader]
        [Route("/getStandardProducts/{ProdCategory}/{GreenType}")]
        public ActionResult getStandardProducts(string ProdCategory,string GreenType)
        {
            var lReturn = new List<StdProductsModels>();

            try
            {
                if (ProdCategory == "BAR6")
                {
                    //if (TempData.ContainsKey("CustomerBar") && TempData["CustomerBar"] != null && TempData["CustomerBar"].ToString().IndexOf("R") >= 0)
                    //{
                    //    TempData["CustomerBar"] = TempData["CustomerBar"].ToString();
                    ...
                    //{
                        lReturn = (from p in db.StdProducts
                                   where p.ProdType == ProdCategory && p.GreenType == GreenType &&
                                   p.Grade != "R"
                                   orderby p.ProdId, p.Grade, p.GreenType
                                   select p
                            ).ToList();
                    //}
                }
        ...
        [Route("/checkOrderStatus/{CustomerCode}/{ProjectCode}/{JobID}")]
        //[ValidateAntiForgeryHeader]
        public ActionResult checkOrderStatus(string CustomerCode, string ProjectCode, int JobID)
        {
                ...
                lCheckJob.UpdateBy != User.Identity.GetUserName()))
            {
                ...
                {
                    return Json(new { success = true, error = false, message = lCheckJob.UpdateBy }, System.Web.Mvc.JsonRequestBehavior.AllowGet);
                }
                else
                {
                    return Json(new
        ...
        public ActionResult uploadPODocs()
        {
            ...
            try
            {
                //var lCustomerCode = Request.Form.Get("CustomerCode");  //need to pass from UI 
                //var lProjectCode = Request.Form.Get("ProjectCode");  //need to pass from UI
                //equest.Form.Get("JobID") //need to pass from UI
                

                var lCustomerCode = "ckg";
                var lProjectCode = "";
                var JobID = 1;
                int lJobID = 0;
                int lDocID = 0;
                //int.TryParse(Request.Form.Get("JobID"), out lJobID);
                int.TryParse("", out lJobID);
        ...
        //download PO doc 
        [HttpPost]
        [Route("/deletePODocs/{CustomerCode}/{ProjectCode}/{JobID}/{PODocID}")]
        //[ValidateAntiForgeryHeader]
        ...
        //download PO doc 
        [HttpPost]
        [Route("/downloadPODocs/{CustomerCode}/{ProjectCode}/{JobID}/{PODocID}")]
        //[ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        //[ValidateAntiForgeryHeader]
        [Route("/checkPODocs/{CustomerCode}/{ProjectCode}/{JobID}/{PODocID}")]
        ...
        [HttpPost]
        // [ValidateAntiForgeryHeader]
        [Route("/sendOrderSubmittedEmail/{CustomerCode}/{ProjectCode}/{JobID}")]
        ...
        //[HttpPost]
        //// [ValidateAntiForgeryHeader]
        //[Route("/getstandardProject/{CustomerCode}")]
        ...
        [HttpGet]
        [Route("/getProjectDetails_Std/{customerCode}/{projectCode}/{UserName}")]
        //[ValidateAntiForgeryHeader]
        public ActionResult getProjectDetails(string CustomerCode, string ProjectCode,string UserName)
        {
            ...
            return Json(content1, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        }
        ...
        //[HttpPost]
        //[Route("/getOrderList/{CustomerCode}/{ProjectCode}")]
        //// [ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        [Route("/getOrderListSearch/{CustomerCode}/{ProjectCode}/{RequiredDateFrom}/{RequiredDateTo}/{PONo}")]
        //[ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        [Route("/getOrderDetails/{CustomerCode}/{ProjectCode}/{JobID}")]
        // [ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        [Route("/setCloneOrder/{CustomerCode}/{ProjectCode}/{JobID}/{CloneNo}")]
        //[ValidateAntiForgeryHeader]
        public ActionResult setCloneOrder(string CustomerCode, string ProjectCode, int JobID, int CloneNo) 
        {
            ...
            try
            {
                ...
                return Json(new { success = true, responseText = "Successfully saved." }, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
                lErrorMsg = ex.Message;
            }
            return Json(new { success = false, responseText = lErrorMsg }, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpGet]
        [Route("/SaveJobAdvice/{CustomerCode}/{ProjectCode}/{JobID}/{OrderStatus}/{TotalPcs}/{TotalWeight}")]
        // [ValidateAntiForgeryHeader]
        ...
        [HttpPost]
        [Route("/OrderWithdraw/{customerCode}/{projectCode}/{JobID}")]
        // [ValidateAntiForgeryHeader]
        ...
        [HttpGet]
        [Route("/getBBS/{customerCode}/{projectCode}/{JobID}")]
        //[ValidateAntiForgeryHeader]
        ...
        [Route("/saveBBS")]
        // [ValidateAntiForgeryHeader]
       public async Task<ActionResult> saveBBS([FromBody] StdProd StdProd)
        {
            var lErrorMsg = "";
            string Message = "";
            try
            {
                //  List<StdProdDetailsModels> StdProdModels

                var StdProdModels = new List<StdProdDetailsModels>();

                db.Database.ExecuteSqlCommand("DELETE FROM OESStdProdDetails " +
                "WHERE CustomerCode = '" + StdProd.CustomerCode + "' " +
                "AND ProjectCode = '" + StdProd.ProjectCode + "' " +
                "AND JobID = " + StdProd.JobID.ToString() + " ");

                if (StdProd.StdProdDetails != null && StdProd.StdProdDetails.Count > 0)
                {
                 
                    for (int i = 0; i < StdProd.StdProdDetails.Count; i++)
                    {
                        StdProd.StdProdDetails[i].SSID = i + 1;
                        StdProd.StdProdDetails[i].UpdateBy = User.Identity.Name;
                        StdProd.StdProdDetails[i].UpdateDate = DateTime.Now;
                        StdProd.StdProdDetails[i].CustomerCode = StdProd.CustomerCode;
                        StdProd.StdProdDetails[i].ProjectCode = StdProd.ProjectCode;
                        StdProd.StdProdDetails[i].JobID = (int)StdProd.JobID;
                        db.StdProdDetails.Add(StdProd.StdProdDetails[i]);
        ...
        //ValidatePONumber
        [HttpPost]
        [Route("/ValidatePONumber/{CustomerCode}/{ProjectCode}/{JobID}/{PONumber}")]
        // [ValidateAntiForgeryHeader]
        public ActionResult ValidatePONumber(string CustomerCode, string ProjectCode, int JobID, string PONumber)
        {
            ...
            try
            {
                ...
                return Json(new { success = true, responseText = lListOrder }, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
                lErrorMsg = ex.Message;
        ...
        //get Bars List 
        [HttpGet]
        [Route("/printOrderDetail/{CustomerCode}/{ProjectCode}/{JobID}")]
        // [ValidateAntiForgeryHeader]
        ...
        //Print Shapes List 
        [HttpGet]
        [Route("/printProduct_ctsmesh/{ProductCategory}")]
        //[ValidateAntiForgeryHeader]
        ...
        //[HttpGet]
        //[Route("/ShowDir")]
        //public IActionResult ShowDir()
        //{
        //    var localFilePath = "D:/Tag Print Application/TagPrintPDF/SampleMesh_PDF";
        //    var directory = new DirectoryInfo(localFilePath);
        //    var myFile = (from f in directory.GetFiles()
        //                  orderby f.LastWriteTime descending
        //                  select f).First();

        //    string fileName = myFile.Name;// "cabnew.pdf";            

        //    localFilePath = Path.Combine(localFilePath, fileName);//getFileFromID(id, out fileName, out fileSize);
        //    // Read the PDF file as a byte array or stream
        ...
        //}
        [HttpGet]
        [Route("/ShowDir/{ProjectCode}/{JobID}")]
        public ActionResult ShowDir(string ProjectCode, int JobID)
        {
            try
            {
                var localFilePath = "D:\\ODOS\\StandardPDF\\STDMESH-" + ProjectCode + "-" + JobID + "\\";
                var directory = new DirectoryInfo(localFilePath);
                var myFile = (from f in directory.GetFiles()
                              orderby f.LastWriteTime descending
                              select f).First();
        ...
        //ADDED FOR PRECAST BY VISHAL WANI

        [HttpGet]

        [Route("/getPrecastDetails/{customerCode}/{projectCode}/{JobID}")]

        //[ValidateAntiForgeryHeader]

        public ActionResult getPrecastDetails(string CustomerCode, string ProjectCode, int JobID)

        {

            var contentStd = (from p in db.OESPrecastDetails
                              ...
                              orderby p.Precast_ID descending
        ...
        [Route("/savePrecastDetails")]

        // [ValidateAntiForgeryHeader]

        public async Task<ActionResult> savePrecastDetails([FromBody] PrecastModel StdProd)

        {
            ...
            try
            {
                if (StdProd.StdPrecastDetail != null )
                {        


                        //StdProd.StdProdDetails.SSID = i + 1;
                        if(StdProd.StdPrecastDetail.Precast_ID==0)
                        {
                            StdProd.StdPrecastDetail.CreatedBy = User.Identity.Name;

                            StdProd.StdPrecastDetail.CreateDate = DateTime.Now;

                            StdProd.StdPrecastDetail.ModifiedBy = User.Identity.Name;

                            StdProd.StdPrecastDetail.ModifiedDate = DateTime.Now;

                            StdProd.StdPrecastDetail.CustomerCode = StdProd.CustomerCode;

                            StdProd.StdPrecastDetail.ProjectCode = StdProd.ProjectCode;

                            StdProd.StdPrecastDetail.JobID = (int)StdProd.JobID;

                            db.OESPrecastDetails.Add(StdProd.StdPrecastDetail);

                            db.SaveChanges();
                        }
                    else if(StdProd.StdPrecastDetail.Precast_ID != 0)
                    {


                        string query = $@"
                        UPDATE OESPrecastDetails
                        SET 
                            CustomerCode     = '{StdProd.CustomerCode}',
                            ProjectCode      = '{StdProd.ProjectCode}',
                            JobID            = {StdProd.JobID},
                            ComponentMarking = '{StdProd.StdPrecastDetail.ComponentMarking}',
                            Block            = '{StdProd.StdPrecastDetail.Block}',
                            Level            = '{StdProd.StdPrecastDetail.Level}',
                            Qty              = {StdProd.StdPrecastDetail.Qty},
                            Remark           = '{StdProd.StdPrecastDetail.Remark}',
                            PageNo           = {StdProd.StdPrecastDetail.PageNo},
                            StructureElement = '{StdProd.StdPrecastDetail.StructureElement}',
                            ModifiedDate     = '{DateTime.Now:yyyy-MM-dd HH:mm:ss}',
                            ModifiedBy       = '{User.Identity.Name}'
                        WHERE Precast_ID = {StdProd.StdPrecastDetail.Precast_ID};
                        ";
