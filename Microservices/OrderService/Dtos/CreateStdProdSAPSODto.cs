...
{
    public class CreateStdProdSAPSODto
    {
        ...
        public List<StdProdDetailsModels> pBBSDetails { get; set; }
        ...
        public int? pOrderNumber { get; set; }

        public string pVehicleType { get; set; }
    }
}
