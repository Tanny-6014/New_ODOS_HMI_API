...
{
    public class CABProductCodeMasterDto
    {
		...
		public bool? CouplerIndicator { get; set; }
		public string? CouplerType { get; set; }
		public int? CoupGradeID { get; set; }
		public int? CouplStdID { get; set; }
		public int? CoupDiameter { get; set; }
        ...
        public int? CoupSAPMaterialID { get; set; }
